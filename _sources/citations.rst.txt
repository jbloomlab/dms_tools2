...
Much of the code is based on the earlier `dms_tools <https://github.com/jbloom/dms_tools>`_ software, so also `see the contributors that earlier project <https://github.com/jbloomlab/dms_tools/graphs/contributors>`_.
