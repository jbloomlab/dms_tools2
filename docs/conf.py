# -*- coding: utf-8 -*-
#
# dms_tools2 documentation build configuration file, created by
...
htmlhelp_basename = 'dms_tools2doc'
...
latex_documents = [
    (master_doc, 'dms_tools2.tex', u'dms\\_tools2 Documentation',
...
man_pages = [
    (master_doc, 'dms_tools2', u'dms_tools2 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dms_tools2', u'dms_tools2 Documentation',
     author, 'dms_tools2', 'One line description of project.',
     'Miscellaneous'),
]
